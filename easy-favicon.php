	...
	*/
	...
	{ 	$avatar = get_avatar( get_bloginfo('admin_email'), '16' );
		...
		switch (get_option('icontype')) {
			...
			case 1 :	echo '<!--[if IE]><link rel="SHORTCUT ICON" type=\'image/x-icon\' href="'.get_bloginfo('wpurl').'/wp-content/plugins/easy-favicon/icons/'.get_option('iconset').'" /><![endif]-->';
			...
			case 3 : echo '<link rel="SHORTCUT ICON" type=\'image/x-icon\' href="'.get_bloginfo('wpurl').'/wp-content/plugins/easy-favicon/icons/'.get_option('iconset').'" />';
